...
This layer provides Board Support Package (BSP) and machine configurations for PolarFire SoC evaluation kits from Microchip's partners for use with OpenEmbedded and/or Yocto Project.
