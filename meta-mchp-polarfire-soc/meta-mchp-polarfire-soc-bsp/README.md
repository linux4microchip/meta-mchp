...
This layer provides Board Support Package (BSP) and machine configurations for Microchip PolarFire SoC evaluation boards for use with OpenEmbedded and/or Yocto Project.
